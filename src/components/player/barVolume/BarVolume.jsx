...
function BarPlayer(props) {
  ...
  const [coordsVolume, setCoordsVolume] = useState({
    x: 0,
    y: 0,
    volume: 0,
    visible: false,
  ...
  return (
    <div className={styles.gridContainer}>
      ...
      <div
        ...
        onMouseDown={(e) => {
          handleMouseDown(e, setIsDraggingVolume);
        }}
        onMouseMove={(e) =>
          handleMouseMove(
            e,
      ...
      >
        {coordsVolume.visible && (
          <div
            ...
            style={{
              left: `${coordsVolume.x}px`,
              top: `${coordsVolume.y - 30}px`,
            }}
          >
        ...
        <div className={styles.centerBar}>
          ...
          <div
            ...
            style={{
              left: `${utils.calculatePercentage(data.barCurrentVolume, 100)}%`,
            }}
          ></div>
        </div>
      </div>
