  ...
  return (
    <div>
      <div className={`${styles.postControls}`}>
        ...
        >
          <input type="checkbox" readOnly checked={selectedRemeberSize} />
          <label className={styles.savePathLabel}>记住桌面</label>
        </div>
      </div>
      <div className={`${styles.postControls}`}>
        <div
        ...
        >
          <input type="checkbox" readOnly checked={selectedDongan} />
          <label className={styles.savePathLabel}>动感光波</label>
        </div>
      </div>
